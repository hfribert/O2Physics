...
DECLARE_SOA_COLUMN(NSigmaHe3Rich, nSigmaHe3Rich, float);           //! NSigma He3 BarrelRich
...
DECLARE_SOA_COLUMN(HasSigHe, hasSigHe, bool);       //! Has nSigma He3 BarrelRich (is He3 over threshold)
