...
// #ifndef PWGCF_FEMTOUNITED_CORE_KINKHISTMANAGER_H_
// #define PWGCF_FEMTOUNITED_CORE_KINKHISTMANAGER_H_
...
// {
//   auto map = makeKinkAnalysisHistSpecMap(confBinningAnalysis);
...
// auto makeKinkQaHistSpecMap(const T1& confBinningAnalysis, const T2 confBinningQa)
// {
//   return std::map<KinkHist, std::vector<framework::AxisSpec>>{
//     {kPt, {confBinningAnalysis.pt}},
//     {kEta, {confBinningAnalysis.eta}},
...
// {
//   // get default map
//   auto map = makeKinkQaHistSpecMap(confBinningAnalysis, confBinningQa);
...
//   ///
//   template <modes::Mode mode, modes::Kink kink>
...
//       if constexpr (isFlagSet(kink, modes::Kink::kLambda)) {
...
//       }
//       if constexpr (modes::isFlagSet(kink, modes::Kink::kK0short)) {
...
//       if constexpr (isFlagSet(kink, modes::Kink::kK0short)) {
...
//   template <modes::Mode mode, modes::Kink kink, typename T>
...
// }; // namespace kinkhistmanager
// }; // namespace o2::analysis::femtounited
// #endif // PWGCF_FEMTOUNITED_CORE_KINKHISTMANAGER_H_
